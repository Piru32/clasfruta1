...
distancia_borojo = math.sqrt(
    (fruta_usuario[0] - borojo[0])**2 +
    (fruta_usuario[1] - borojo[1])**2 +
    (fruta_usuario[2] - borojo[2])**2
)
...
st.write("🍑 Borojo:", distancia_borojo)
